                ...
                <Form>
                  ...
                  <Form.Group className="mb-2">
                    ...
                    <div className="d-flex gap-2">
                      <Form.Control
                        type="number"
                        value={form.royaltyAmount}
                        onChange={(e) =>
                          handleInputChange(req.id, "royaltyAmount", e.target.value)
                        }
                      />
                      <Form.Select
                        value={form.royaltyCurrency}
                        onChange={(e) =>
                          handleInputChange(req.id, "royaltyCurrency", e.target.value)
                        }
                      >
                        <option>SBP</option>
                        <option>RACE</option>
