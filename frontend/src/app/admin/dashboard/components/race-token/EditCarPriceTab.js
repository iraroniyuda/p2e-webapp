...
export default function EditCarPriceTab() {
  ...
  const handleSaveUpgradeConfig = async (partType) => {
    try {
      ...
      await updateUpgradeFlatPriceConfig(partType, newPrice, newValueSBP);
            ...
            <tr key={config.partType}>
              ...
              <td>
                <Form.Control
                  type="number"
                  value={
                    editedUpgradePrice[config.partType] ??
                    parseFloat(config.price)
                  }
                  onChange={(e) =>
              ...
              <td>
                <Form.Control
                  type="number"
                  value={
                    editedUpgradeSBP[config.partType] ??
                    parseFloat(config.valueSBP)
                  }
                  onChange={(e) =>
