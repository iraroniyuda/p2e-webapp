...
import CompanyExchangerTab from "../components/exchanger/CompanyExchangerTab";
import ExchangerConfigTab from "../components/exchanger/ExchangerConfigTab";
...
export default function ExchangerPage() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "config":
        return <ExchangerConfigTab />;
      case "company":
        return <CompanyExchangerTab />;
      default:
        return <ExchangerConfigTab />;
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-2xl font-bold mb-4">Manajemen Exchanger</h1>
